...
const sounds = [
  ...
  { emoji: '🎶', label: "Among Us role reveal sound", file: "https://www.myinstants.com/media/sounds/among-us-role-reveal-sound.mp3" },
  ...
  { emoji: '🎶', label: "spiderman meme song", file: "https://www.myinstants.com/media/sounds/spiderman-meme-song.mp3" },
  { emoji: '🔊', label: "RUN vine", file: "https://www.myinstants.com/media/sounds/run-vine-sound-effect.mp3" },
  ...
  { emoji: '🌀', label: "DEJA VU MEME", file: "https://www.myinstants.com/media/sounds/deja-vu.mp3" },
  ...
  { emoji: '🌀', label: "Coffin Dance Meme", file: "https://www.myinstants.com/media/sounds/y2mate-mp3cut_sRzY6rh.mp3" },
  ...
  { emoji: '🔊', label: "AUUGHHH", file: "https://www.myinstants.com/media/sounds/auughhh.mp3" },
  ...
  { emoji: '🌀', label: "Meme Snoop", file: "https://www.myinstants.com/media/sounds/tmpv1j67tyy.mp3" },
  { emoji: '🌀', label: "Meme money", file: "https://www.myinstants.com/media/sounds/shane-mcmahon-here-comes-the-money-entrance-theme-mp3cut_zYoMFim.mp3" },
  ...
  { emoji: '🐶', label: "Meme Snoop Dogg", file: "https://www.myinstants.com/media/sounds/tmpktrnct0r.mp3" },
